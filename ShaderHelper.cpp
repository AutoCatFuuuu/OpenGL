...
ShaderHelper::ShaderHelper(const char* vertexPath, const char* fragmentPath, const char* geometryPath)
{
...
void ShaderHelper::checkCompileErrors(unsigned int shader, std::string type,std::string path)
{
    int success;
    char infoLog[1024];
    if (type != "PROGRAM")
